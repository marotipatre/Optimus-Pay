...
import pro6 from "./assets/6.png";
import pro7 from "./assets/7.jpg";
import pro8 from "./assets/8.png";
import pro9 from "./assets/9.jpg";
import pro10 from "./assets/10.png";
import pro11 from "./assets/11.png";
import pro12 from "./assets/12.png";
import pro13 from "./assets/13.png";
...
export const products = [
  {
    ...
    name: "Iphone 14",
    description:
      "The extraordinary battery life, lightweight design, pro-level camera and video features, groundbreaking safety capabilities.",
